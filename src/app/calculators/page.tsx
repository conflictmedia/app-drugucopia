...
export default function CalculatorsPage() {
  // No pull-to-refresh here: this page is fully static (router.refresh() is
  // a no-op in the static export, so the gesture previously showed a spinner
  // and haptic feedback for nothing).
  return (
